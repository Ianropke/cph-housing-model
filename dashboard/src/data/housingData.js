...
const cphApartments = [81.4, 82.4, 82.1, 82.5, 83.8, 85.8, 88.1, 90.9, 95.6, 97.8, 100.2, 98.9, 102.2, 103.3, 99.6, 95.0, 94.7, 98.1, 98.8, 99.0, 98.3, 102.3, 105.0, 107.3, 112.5, 118.9, 121.8, 129.2];
const cphHouses = [79.3, 80.0, 80.9, 79.9, 81.6, 81.9, 86.5, 89.4, 95.1, 98.4, 101.4, 100.9, 103.2, 104.1, 98.3, 94.5, 93.4, 95.7, 97.8, 99.6, 98.0, 100.3, 101.7, 104.1, 106.8, 110.3, 112.3, 118.5];
const fredApartments = [84.0, 84.7, 83.1, 85.8, 87.9, 84.6, 88.2, 89.4, 96.3, 97.5, 98.8, 99.4, 101.2, 103.6, 99.5, 95.7, 91.7, 94.9, 97.8, 97.5, 98.0, 99.5, 102.6, 103.1, 105.4, 108.2, 110.7, 114.6];
...
export const ewiModes = {
  "yoy_original": {
    ...
    "compositeScore": 6.8,
    "freshnessWeightedComposite": 7.4,
    "alertLevel": "ELEVATED",
    "maxRiskIndex": {
      "6m": {
        "score": 11,
        ...
        "components": {
          ...
          "ewi_contribution": 14.4,
          "avg_data_freshness": 0.57
        }
      },
      "12m": {
        "score": 27,
  ...
  "structural_3y": {
    ...
    "compositeScore": 4.0,
    "freshnessWeightedComposite": 4.2,
    "alertLevel": "NORMAL",
    "maxRiskIndex": {
      "6m": {
        "score": 9,
...
export const freshnessWeightedComposite = 7.4;
export const alertLevel = 'ELEVATED';
export const lastUpdated = '2026-07-05 · 2025Q4 Data';
