...
export const earlyWarningIndicators = [
  ...
  },
  {
    ...
    "baseline": "4.5 months",
    "status": "GREEN",
    "description": "Months of supply: 5.2 (baseline: 4.5)",
  ...
  },
  {
    ...
    "status": "AMBER",
    "description": "39% of listings reduced, avg 5.1%",
    "freshness_weight": 1.0,
    "last_updated": "2026-09-17"
  },
  {
...
export const ewiModes = {
  "yoy_original": {
    ...
    "compositeScore": 10.5,
    "freshnessWeightedComposite": 9.3,
    "alertLevel": "HIGH",
    "maxRiskIndex": {
      "6m": {
        "score": 9,
        ...
        "components": {
          ...
          "ewi_contribution": 29.7,
          "avg_data_freshness": 0.76
        }
      },
      "12m": {
        "score": 9,
    ...
    "dataFreshness": {
      ...
      "rkr_udb010": {
        ...
        "freshness_weight": 1.0,
        "next_expected_update": "2026-10-17"
      },
      "boliga_listings": {
        ...
        "source": "Boliga API",
        "freshness_weight": 1.0,
        "next_expected_update": "2026-09-18"
      },
      "rkr_ul10": {
        ...
        "source": "Finansdanmark",
        "freshness_weight": 1.0,
        "next_expected_update": "2026-12-17"
      },
      "ecb_rates": {
        "label": "ECB renter",
        "last_updated": "2026-09-01",
  ...
  "structural_5y": {
    ...
    "compositeScore": 7.7,
    "freshnessWeightedComposite": 6.8,
    "alertLevel": "ELEVATED",
    "maxRiskIndex": {
      "6m": {
        "score": 7,
...
export const freshnessWeightedComposite = 9.3;
export const alertLevel = 'HIGH';
export const mlCrashProbability = null;
export const lastUpdated = '2026-09-17 · 2026Q1 Data';
