...
export const earlyWarningIndicators = [
  ...
  },
  {
    ...
    "baseline": "<4.0%",
    "status": "GREEN",
    "description": "Ledighed er 3.7% (AMBER >4.0%, RED >5.5%)",
...
export const ewiModes = {
  ...
  "structural_3y": {
    ...
    "compositeScore": 4.0,
    "freshnessWeightedComposite": 3.8,
    "alertLevel": "NORMAL",
    "maxRiskIndex": {
      "6m": {
        "score": 9,
...
export const mlCrashProbability = 0.41;
